...
import (
	...
	"github.com/gsemer/ardanlabs-service/business/data/migrate"
...
func GenToken() error {
	...
	token.Header["kid"] = "57af22c4-c715-4a6b-aef9-5bb69dfdba79"

	privateKeyPEM, err := os.ReadFile("zarf/keys/57af22c4-c715-4a6b-aef9-5bb69dfdba79.pem")
	if err != nil {
...
// GenKey generates an x509 pivate/public key for auth tokens.
func GenKey() error {
