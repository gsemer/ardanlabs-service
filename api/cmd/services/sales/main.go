...
import (
	...
	"github.com/gsemer/ardanlabs-service/api/cmd/services/sales/build/all"
	"github.com/gsemer/ardanlabs-service/api/http/api/debug"
...
func run(ctx context.Context, log *logger.Logger) error {
	...
	// This is a main's child goroutine.
	// It is recommended that the parent goroutines shouldn't terminate before their children.
	go func() {
